            ...
            <x-slot name="header">
                ...
                <div class="d-flex">
                    <div class="py-2 d-flex justify-content-end align-items-center">
                        <form method="GET" action="{{ route('providers.products',$provider->id) }}" class="d-flex align-items-center m-1"
                            role="search">
                        ...
                        <a href="{{ route('providers.products',$provider->id) }}" class="btn btn-secondary ms-2" title="@lang('dashboard.reset')">
