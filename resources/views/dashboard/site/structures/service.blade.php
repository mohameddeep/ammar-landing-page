...
@section('content')
    <div class="container-fluid px-5 py-3">
        <!-- Page Header -->
        <x-breadcrumb.breadcrumb title="{{ __('dashboard.services') }}" :breadcrumbs="[['name' => __('dashboard.services'), 'route' => 'service_structure.index']]" />
        <!-- Page Header Close -->
        <x-cards.page-card>
            <x-slot name="about">
            ...
            <x-form.form-component :route="route('service_structure.store')" method="POST" enctype="multipart/form-data">

                {{-- section 1 --}}
                <h3 class="text-muted">@lang('dashboard.services')</h3>
