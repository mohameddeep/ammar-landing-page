...
@section('title', __('dashboard.about_content'))
@section('content')
    <div class="container-fluid px-5 py-3">
        <!-- Page Header -->
        <x-breadcrumb.breadcrumb title="{{ __('dashboard.about_content') }}" :breadcrumbs="[['name' => __('dashboard.about_content'), 'route' => 'abouts.index']]" />
        <!-- Page Header Close -->
        <x-cards.page-card>
            <x-slot name="header">
                <div class="card-title">
                    @lang('dashboard.about_content')
                </div>
                <div class="d-flex">
                    <div class="py-2 d-flex justify-content-end align-items-center">

                        <x-buttons.create-button :route="route('abouts.children.create',$parent->id)" />
                            ...
                            <tr id="row-{{ $about->id }}">
                                ...
                                <td>
                                    <div class="hstack gap-2 fs-15">
                                        <x-buttons.edit-button :route="route('abouts.children.edit', $about->id)" />
