                ...
                <x-cards.page-card>
                    <div class="card custom-card">
                        <div class="card-body d-flex align-items-center flex-wrap">
                            <div class="flex-fill">
                                <span class="mb-0 fs-14 text-muted">@lang('dashboard.total_orders') : <span
                                        class="fw-semibold text-success">{{ $ordersCount }}</span></span>
                            </div>
                            {{-- <div class="dropdown">
                                <button class="btn btn-light dropdown-toggle m-1" type="button" id="dropdownMenuButton1"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    @lang('dashboard.sort_by') 
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item" href="#">@lang('dashboard.date')</a></li>
                                    <li><a class="dropdown-item" href="#">@lang('dashboard.price')</a></li>
                                    <li><a class="dropdown-item" href="#">@lang('dashboard.category')</a></li>
                                </ul>
                            </div> --}}
                ...
                <x-cards.page-card>
                    ...
                    <div class="card-footer d-sm-flex d-block align-items-center justify-content-between">
                        ...
                        <div class="mt-sm-0 mt-2">
                            <a href="{{route('orders.show',$order->id)}}" class="btn btn-sm btn-primary-light"> @lang('dashboard.order_details')</a>
                        </div>
