...
@section('content')
    <div class="container-fluid px-5 py-3">
        <!-- Page Header -->
        <x-breadcrumb.breadcrumb title="{{ __('dashboard.commissions') }}" :breadcrumbs="[['name' => __('dashboard.commissions')], ['name' => __('dashboard.Edit')]]" />
        ...
        <x-cards.page-card>
            ...
            <x-form.form-component :route="route('commissions.update', $commission->id)" method="PUT">
                ...
                <x-input.input-field type="select" name="value_type" label="{{ __('dashboard.value_type') }}"
                    placeholder="{{ __('dashboard.value_type') }}" :options="CommissionValueTypeEnum::values()" :value="$commission->value_type" showName="name_en" />
