...
@section('title', __('dashboard.landing_header'))
@section('content')
    <div class="container-fluid px-5 py-3">
        <!-- Page Header -->
        <x-breadcrumb.breadcrumb title="{{ __('dashboard.landing_header') }}" :breadcrumbs="[['name' => __('dashboard.landing_header')], ['name' => __('dashboard.Edit')]]" />
        ...
        <x-cards.page-card>
            ...
            <x-form.form-component :route="route('landingPage.update', $content->id)" method="PUT">
                ...
                <x-input.input-field name="ios_link" label="{{ __('dashboard.ios_link') }}"
                    placeholder="{{ __('dashboard.ios_link') }}" class="custom-class" id="ios_link" :value="$content->ios_link" />
