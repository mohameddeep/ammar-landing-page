...
<div class="container-fluid px-5 py-3">
    <!-- Page Header -->
    <x-breadcrumb.breadcrumb title="{{ __('dashboard.order_returns') }}" :breadcrumbs="[['name' => __('dashboard.order_returns'), 'route' => 'order_returns.index'], ['name' => __('dashboard.order_items')]]" />
    <!-- Page Header Close -->
    <div class="row ">
        <div class="col-xl-6">
                ...
                <x-cards.page-card>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="p-3 border-bottom border-block-end-dashed">
                            ...
                            <p class="mb-2 text-muted"><span class="fw-semibold text-default">@lang('dashboard.building_name') : </span>{{ $order?->address?->building_name }}</p>
                            <p class="mb-2 text-muted"><span class="fw-semibold text-default">@lang('dashboard.landmark') : </span>{{ $order?->address?->landmark }}</p>
                            <p class="mb-2 text-muted"><span class="fw-semibold text-default">@lang('dashboard.street') : </span>{{ $order?->address?->street_name }}</p>
                            <p class="mb-2 text-muted"><span class="fw-semibold text-default">@lang('dashboard.city') : </span>{{ $order?->address?->city }}</p>
                            <p class="mb-2 text-muted"><span class="fw-semibold text-default">@lang('dashboard.notes') : </span>{{ $order?->address?->notes }}</p>
                        </div>
                        <div class="p-3 border-bottom border-block-end-dashed">
                            <div class="mb-3">
